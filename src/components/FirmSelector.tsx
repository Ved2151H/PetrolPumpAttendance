  ...
  return (
    <div className="grid sm:grid-cols-2 gap-6">
      ...
      >
        ...
        <div className="w-14 h-14 bg-orange-500 text-white rounded-xl flex items-center justify-center mb-6 shadow-md transition-transform group-hover:scale-110">
        ...
        <div className="mt-8 flex items-center text-orange-600 group-hover:text-orange-400 font-semibold text-sm">
          <span>Enter Workspace</span>
          <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
        </div>
      </button>
